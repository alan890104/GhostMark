(() => {
  const copy = {
    en: {
      ...
      lede: "Paste an image in Claude Code, Claude Desktop, or Codex. GhostMark opens a focused markup window, then sends the finished image straight back to your AI agent.",
    ...
    "zh-TW": {
      ...
      lede: "在 Claude Code、Claude 或 Codex 貼上圖片，GhostMark 會先開啟標記視窗。圈選、畫線或畫出操作流程，再把完成的圖片直接送給 AI Agent。",
